...
** Philsophy 
Its philosophy lies with in the same unix philosophy do one thing and do it well. So instead of having make files with rules and targets all you need to do is define your file. It will handle all the rulling for you instead of you creating it.
